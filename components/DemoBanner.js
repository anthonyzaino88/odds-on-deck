...
export default function DemoBanner() {
  ...
  return (
    // Hidden on mobile (< 768px), compact on desktop
    <div className="hidden md:block bg-gradient-to-r from-blue-600 to-purple-600 text-white py-2 px-4">
      <div className="container mx-auto flex items-center justify-between">
        ...
        <a 
          ...
          className="bg-white/20 hover:bg-white/30 rounded px-3 py-1 text-xs font-medium transition flex items-center gap-2"
        >

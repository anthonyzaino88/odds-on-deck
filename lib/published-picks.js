...
/**
 * Editor's-Picks bar (desk / ranker follow-up — not the public homepage).
 * No juice trap + odds band + MLB/NFL. Does not pretend to be Published
 * (no QS / edge floors). Homepage must not use this as fallback fill.
 * @param {object} record
 * @param {{ sports?: string[] }} [opts]
 * @returns {boolean}
 */

...
export async function enrichPropsWithTeamContext(props) {
  ...
  try {
    ...
    let propsWithoutContext = 0;
    let propsContextNull = 0;
    ...
    console.log(`   Debug: ${propsWithContext} got context, ${propsWithoutContext} no game match, ${propsContextNull} returned null`);

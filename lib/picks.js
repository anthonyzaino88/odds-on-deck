...
/**
 * Game-level ML / totals from EdgeSnapshot. Kept for ops / future game
 * cards. The public Editor's desk does not call this — Pile B is props
 * only, via generatePlayerPropPicks + rankEditorsPicks.
 */

...
import { unitsFromResult, impliedProbabilityFromOdds, detectOddsFormat } from './odds-units.js'
import { getBookCount, attachNumBooks } from './juice-traps.js'
import { summarizePublishedPicks } from './published-picks.js'
...
export async function getPublishedPicksStats(options = {}) {
  try {
    const validations = await fetchCompletedValidations({
      days: options.days,
    })
